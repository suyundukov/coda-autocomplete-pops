...
var get = Em.get, set = Em.set, none = Em.none;
...
*/
JUI.TargetSupport = Em.Mixin.create({

  // @private
  targetObject: function() {
    var target = get(this, 'target');

    if (Em.typeOf(target) === 'string') {
      return Em.getPath(this, target);
    } else {
      return target;
    }
  ...
  executeAction: function() {
    var args = Em.$.makeArray(arguments),
        action = args.shift(),
        target = get(this, 'targetObject');
    if (target && action) {
      if (Em.typeOf(action) === 'string') {
...
*/
JUI.AutocompleteItem = Em.View.extend({
  tagName: 'li',
  defaultTemplate: Em.Handlebars.compile('<a>{{content.label}}</a>'),
  didInsertElement: function() {
    this._super();
...
*/
JUI.AutocompleteTextField = Em.TextField.extend(JUI.Widget, JUI.TargetSupport, {
...
/**
  ...
  @extends JUI.Button
*/
JUI.Button = Em.Button.extend(JUI.Widget, {
  uiType: 'button',
  uiOptions: ['label', '_icons'],

  isActiveBinding: Em.Binding.oneWay('.disabled'),
...
*/
JUI.DialogButton = Em.Object.extend(JUI.TargetSupport, {
  title: 'OK',
  action: 'close',
  executeAction: function() {
...
/**
  ...
  @extends JUI.Dialog
*/
JUI.Dialog = Em.View.extend(JUI.Widget, JUI.TargetSupport, {
  uiType: 'dialog',
  ...
  defaultTemplate: Em.Handlebars.compile('<p>{{message}}</p>'),

  open: function() {
    if (get(this, 'state') !== 'inDOM') {
      this._insertElementLater(Em.K);
    } else {
      get(this, 'ui').open();
    }
  },
...
*/
JUI.Datepicker = Em.TextField.extend(JUI.Widget, {
  uiType: 'datepicker',
  ...
  uiWidget: function() {
    var datepicker = function(options, elem) {
      return Em.$(elem).datepicker(options).datepicker('widget');
    };
    datepicker.prototype.options = Em.$.datepicker._defaults;
    return datepicker;
  }.property().cacheable(),
...
JUI.Datepicker.formatDate = Em.$.datepicker.formatDate;
JUI.Datepicker.parseDate = Em.$.datepicker.parseDate;
...
*/
JUI.ProgressBar = Em.View.extend(JUI.Widget, {
  uiType: 'progressbar',
...
/**
  ...
  @extends JUI.Slider
*/
JUI.Slider = Em.View.extend(JUI.Widget, {
  uiType: 'slider',
...
/**
  ...
  @extends JUI.Spinner
*/
JUI.Spinner = Em.TextField.extend(JUI.Widget, {
  uiType: 'spinner',
